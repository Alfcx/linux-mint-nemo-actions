...
| -------------------------- | ----------------------------------------------------------- |
| Scan to Sandwich PDF       | Takes your scanned document (tif or pdf), splits double     |
|                            | pages, corrects the alignement, sets the document to black  |
|                            | and white, runs text recognition, adds a text layer to the  |
|                            | document. You end up with a seachable/indexable pdf         |
|                            | document. Also backs up the original file in an archive     |
|                            | directory.                                                  |
| -------------------------- | ----------------------------------------------------------- |
